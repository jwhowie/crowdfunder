...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { amount: @pledge.amount, product_id: @pledge.product_id, reward_id: @pledge.reward_id, user_id: @pledge.user_id }
    end
  ...
  test "should update pledge" do
    patch :update, id: @pledge, pledge: { amount: @pledge.amount, product_id: @pledge.product_id, reward_id: @pledge.reward_id, user_id: @pledge.user_id }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
