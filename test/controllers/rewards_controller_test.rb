...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { amount: @reward.amount, description: @reward.description, product_id: @reward.product_id, title: @reward.title }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { amount: @reward.amount, description: @reward.description, product_id: @reward.product_id, title: @reward.title }
    assert_redirected_to reward_path(assigns(:reward))
  end
